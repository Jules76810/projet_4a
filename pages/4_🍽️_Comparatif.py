...
st.write("Nous avons décidé de former des couples de produits pour répondre à notre problématique d'origine qui est : - Quel est l'impact de certains produits similaires appartenantx au même groupe d'aliment ?")
